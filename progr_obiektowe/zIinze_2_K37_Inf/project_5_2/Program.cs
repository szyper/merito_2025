namespace project_5
{
    ...
    internal class Program
    {
        ...
        private static void ExecuteWork(List<IPrintable> list)
        {
            Console.WriteLine("\n=== Praca ===");
        ...
        private static void PrintDetails(List<IPrintable> list)
        {
            Console.WriteLine("\n=== Szczegóły obiektów ===");
            foreach (var obj in list)
            {
        ...
        private static void PrintAll(List<IPrintable> list)
        {
            Console.WriteLine("\n=== Lista obiektów ===");
            foreach (var obj in list)
            {
        ...
        private static void AddWorker(List<IPrintable> list)
        {
            Console.Write("Imię: ");
        ...
        private static void AddStudent(List<IPrintable> list)
        {
            Console.Write("Imię: ");
            string name = Console.ReadLine();
            Console.Write("Wiek: ");
        ...
        private static void AddPerson(List<IPrintable> list)
        {
            Console.Write("Imię: ");
            string name = Console.ReadLine();
            Console.Write("Wiek: ");
